...
import net.gegy1000.slyther.network.message.server.MessageNewPreyBase;

public class MessageNewPrey extends MessageNewPreyBase implements MessageFromServer {
